...
export const ADULT_BOARD: Tile[] = [
  { type: "start", prompt: "Start Here", emoji: "🚀" },
  { type: "light", prompt: "Drink if you have flirted today", altDrink: "or take a sip", emoji: "🍷" },
  { type: "social", prompt: "Hot truth or drink", altDrink: "or drink twice", emoji: "🎭" },
  { type: "cheeky", prompt: "Give someone your boldest pickup line", altDrink: "or drink", emoji: "😏" },
  { type: "couple", prompt: "Air-kiss or kiss someone who clearly agrees", altDrink: "or sip", emoji: "💋" },
  { type: "special", prompt: "Safe Zone - hydrate and breathe", emoji: "✨", effect: { kind: "safe" } },
  { type: "wild", prompt: "Group chooses a hot-but-comfortable dare", altDrink: "or drink twice", emoji: "🔥" },
  { type: "light", prompt: "Describe your type in 3 words", emoji: "💬" },
  { type: "social", prompt: "Shot or bold dare?", altDrink: "or drink", emoji: "🥃" },
  { type: "couple", prompt: "Share one romantic green flag", altDrink: "or drink", emoji: "🚩" },
  { type: "cheeky", prompt: "Show your most confident selfie pose", altDrink: "or drink", emoji: "📸" },
  { type: "special", prompt: "Skip your next turn", emoji: "⏭️", effect: { kind: "skip" } },
  { type: "wild", prompt: "Act out your ideal first-date entrance", altDrink: "or drink", emoji: "🎬" },
  { type: "light", prompt: "Compliment someone like you mean it", emoji: "🌟" },
  { type: "social", prompt: "Would You Rather - make it spicy", altDrink: "or drink", emoji: "🤔" },
  { type: "couple", prompt: "Whisper a bold compliment to the player on your right", altDrink: "or drink", emoji: "🤫" },
  { type: "cheeky", prompt: "Read a flirty line in your best voice", altDrink: "or drink", emoji: "📱" },
  { type: "special", prompt: "Go back 3 spaces", emoji: "↩️", effect: { kind: "back", n: 3 } },
  { type: "wild", prompt: "Take a direct dare from the group", altDrink: "or drink twice", emoji: "🔥" },
  { type: "light", prompt: "Name the song that makes you feel dangerous", emoji: "🎵" },
  { type: "social", prompt: "Never Have I Ever - spicy edition", emoji: "🫶" },
  { type: "couple", prompt: "Slow dance for 10 seconds with someone who agrees", altDrink: "or drink", emoji: "💃" },
  { type: "cheeky", prompt: "Give your best movie-star bedroom eyes", altDrink: "or drink", emoji: "🎭" },
  { type: "end", prompt: "You made it - claim the crown", emoji: "👑" },
];
